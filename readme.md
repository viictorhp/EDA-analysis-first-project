...
Kaggle es una plataforma online de ciencia de datos y machine learning donde la gente puede descargar datasets, subir los suyos y participar en competiciones de modelado predictivo.
Considero que esta fuente es fiable para fines educativos y de análisis de datos, ya que, la propia comunidad ayuda a detectar errores y a mejorar la calidad mediante votos, comentarios y notebooks asociados.
...
Este dataset contiene 399.342 registros (filas) y 18 columnas. Esto indica que cada fila corresponde a un atleta, que se puede identificar por su id o también por su nombre y apellidos y cada columna a una variable o característica registrada sobre ese atleta.
...
En esta fase del análisis, he renombrado algunos nombres de las variables para que se entienda mejor qué están representando, he eliminado algunas columnas de forma justificada y he tratado los valores nulos y atípicos.
...
En esta última fase he realizado varias visualizaciones y demostraciones interesantes. He establecido relaciones entre algunas variables para ver cómo se comportan y he presentado todos los resultados tanto en tablas como en gráficas.
...
El proyecto se divide en dos notebooks: El primero en el cuál se visualizan y se estudian los datos y se realizan las transformaciones de limpieza necesarias y el segundo dónde se ha realizado toda la parte de visualización y agrupación de los datos.

Además he creado un archivo principal de python llamado "visualization.py" en el cuál he englobado todas las funciones usadas en la parte de agrupación y visualización (en el segundo notebook).