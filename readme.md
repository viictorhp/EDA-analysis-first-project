...
Contiene datos sobre sus rendimientos en determinadas competencias y entrenamientos, edad, género, altura, peso... y con ello podré realizar un buen análisis y detectar si existen correlaciones entre algunas variables; como por ejemplo rendimiento con experiencia, rendimiento con edad, diferencias entre géneros, desempeño según las modalidades de los ejercicios, etc.
...
Dominio a mi base de Datos: [Crossfit Athletes](https://www.kaggle.com/datasets/ulrikthygepedersen/crossfit-athletes)
...
Este dataset contiene 423006 registros (filas) y 27 columnas. Esto indica que cada fila corresponde a un atleta, que se puede identificar por su id o también por su nombre y apellidos y cada columna a una variable o característica registrada sobre ese atleta.
Las variables (columnas) contienen datos de todo tipo sobre los atletas
    ...
    - Datos de rendimiento: pesos en diferentes ejercicios de fuerza y tiempos en diferentes ejercicios de cardio.
Podemos decir que este dataset cuenta con un nivel de granularidad alto, ya que, contiene información bastante específica y detallada sobre los atletas 

#### Tipos de datos
Tenemos datos individuales(con elevada granularidad) de tipo **float** (métricas numéricas), como pueden ser la edad, el peso, la altura... y algunos otros datos de tipo **object** (variables de texto), como la región, el equipo...
